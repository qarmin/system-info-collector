...
pub struct LayoutFields {
    ...
    // Patched locally: upstream plotly-rs only goes up to axis 8
    // (https://github.com/plotly/plotly.rs), which caps our chart grid at 8
    // rows. FieldSetter/layout_structs are fully generic over struct fields,
    // so extending this list is enough to unlock more subplot rows.
    #[serde(rename = "xaxis9")]
    x_axis9: Option<Box<Axis>>,
    #[serde(rename = "yaxis9")]
    y_axis9: Option<Box<Axis>>,
    #[serde(rename = "zaxis9")]
    z_axis9: Option<Box<Axis>>,
    #[serde(rename = "xaxis10")]
    x_axis10: Option<Box<Axis>>,
    #[serde(rename = "yaxis10")]
    y_axis10: Option<Box<Axis>>,
    #[serde(rename = "zaxis10")]
    z_axis10: Option<Box<Axis>>,
    #[serde(rename = "xaxis11")]
    x_axis11: Option<Box<Axis>>,
    #[serde(rename = "yaxis11")]
    y_axis11: Option<Box<Axis>>,
    #[serde(rename = "zaxis11")]
    z_axis11: Option<Box<Axis>>,
    #[serde(rename = "xaxis12")]
    x_axis12: Option<Box<Axis>>,
    #[serde(rename = "yaxis12")]
    y_axis12: Option<Box<Axis>>,
    #[serde(rename = "zaxis12")]
    z_axis12: Option<Box<Axis>>,
